...
> models::PasswordLoginResponse post_login(password_login_attempt)
...
[**models::PasswordLoginResponse**](PasswordLoginResponse.md)
...
> models::AuthorizationResponse post_login_authorize(authorization_request)
...
[**models::AuthorizationResponse**](AuthorizationResponse.md)
