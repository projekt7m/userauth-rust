...
impl ListWrapperClientDataInner {
    pub fn new(client_id: uuid::Uuid, name: String, redirect_uri: String, refresh_token: bool, last_change: String) -> ListWrapperClientDataInner {
        ListWrapperClientDataInner {
            client_id,
            name,
            redirect_uri,
            refresh_token,
