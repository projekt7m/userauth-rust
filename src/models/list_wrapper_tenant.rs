...
pub struct ListWrapperTenant {
    #[serde(rename = "data")]
    pub data: Vec<models::ListWrapperTenantDataInner>,
}

impl ListWrapperTenant {
    pub fn new(data: Vec<models::ListWrapperTenantDataInner>) -> ListWrapperTenant {
        ListWrapperTenant {
            data,
        }
    }
