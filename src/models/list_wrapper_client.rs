...
pub struct ListWrapperClient {
    #[serde(rename = "data")]
    pub data: Vec<models::ListWrapperClientDataInner>,
}

impl ListWrapperClient {
    pub fn new(data: Vec<models::ListWrapperClientDataInner>) -> ListWrapperClient {
        ListWrapperClient {
            data,
        }
    }
